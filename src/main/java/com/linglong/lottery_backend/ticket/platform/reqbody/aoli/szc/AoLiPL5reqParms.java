...
@Service
public class AoLiPL5reqParms extends AoLiSZCreqNumbers implements CreatePL5reqParms {
    ...
    protected JSONObject createSZCreqBody(List<TicketNumber> ticketNumbers, TicketDto ticketDto, AoLiSZCreqNumbers aoLiSZCreqNumbers) {
        ...
        ticketNumbers.forEach(ticketNumber -> {
            ...
            String[] lotteryNumber = lotteryNumbers[0].split(CommonConstant.SPACE_SPLIT_STR);
            ...
            betContentData.put("playType", "P5Direct");
    ...
    protected JSONArray createNumbers(String[] lotteryNumbers, String playType) {
        ...
        for (int i = 0; i < lotteryNumbers.length; i++) {
            ...
            numbersData.put("area1List",JSONArray.fromObject(balls[0].split(CommonConstant.COMMA_SPLIT_STR)));
            numbersData.put("area2List",JSONArray.fromObject(balls[1].split(CommonConstant.COMMA_SPLIT_STR)));
            numbersData.put("area3List",JSONArray.fromObject(balls[2].split(CommonConstant.COMMA_SPLIT_STR)));
            numbersData.put("area4List",JSONArray.fromObject(balls[3].split(CommonConstant.COMMA_SPLIT_STR)));
            numbersData.put("area5List",JSONArray.fromObject(balls[4].split(CommonConstant.COMMA_SPLIT_STR)));
